...
toy_story = media.Movie("Toy Story", "A story of a boy and his toys that has come to life",
                        "https://upload.wikimedia.org/wikipedia/en/1/13/Toy_Story.jpg",
                        "https://www.youtube.com/watch?v=KYz2wyBy3kc")
avatar = media.Movie("Avatar", "Avatar story",
...
hunger = media.Movie("Hunger Games",
                     ...
                     "https://upload.wikimedia.org/wikipedia/en/0/09/Catching_fire.JPG",
                     "https://www.youtube.com/watch?v=KmYNkasYthg")
spider = media.Movie("Spiderman",
                     "Fictional character and superhero appearing in American comic books published by Marvel Comics existing in its shared universe",
...
terminator = media.Movie("Terminator",
                         "A cyborg assassin sent back in time from the year 2029 to 1984 to kill Sarah Connor",
                         "https://upload.wikimedia.org/wikipedia/en/8/85/Terminator2poster.jpg",
                         "https://www.youtube.com/watch?v=rGSxss7gWak")
hobbit = media.Movie("Hobbit", "Hobbit story",
